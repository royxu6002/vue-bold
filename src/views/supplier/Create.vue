<template>
    <div class="supplier-create-page container mt-3">
        <h6>this is supplier create page</h6>
...
export default {
    ...
    methods: {
        submitData() {
            this.axios.post(this.GLOBAL.baseUrl+"/supplier", this.qs.stringify(this.supplierData))
            .then(res => {
